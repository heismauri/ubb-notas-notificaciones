/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f5265a303ef955d9042f40da23185dbc)
// Runtime types generated with workerd@1.20250906.0 2025-09-11 
declare namespace Cloudflare {
	interface Env {
		ubbnotas: KVNamespace;
		MARKS_ENDPOINT: string;
		MODULAR_MARKS_ENDPOINT: string;
		RUN: string;
		TOKEN: string;
